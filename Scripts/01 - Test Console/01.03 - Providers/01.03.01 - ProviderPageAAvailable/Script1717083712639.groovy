...
WebUI.click(findTestObject('Object Repository/Page_Settings/a_Settings'))

WebUI.click(findTestObject('Object Repository/Page_Settings/span_Providers'))

WebUI.verifyTextPresent('Providers', true)

WebUI.verifyTextPresent('Active providers', false)

WebUI.verifyTextPresent('Available providers', false)
